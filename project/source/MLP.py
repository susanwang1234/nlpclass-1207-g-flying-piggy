...
class MLP:
    ...
    def set_up(self):
        self.model.add(layers.Input(shape = (self.MAX_SEQUENCE_LENGTH,)))
        self.model.add(layers.Embedding(self.max_features, self.embed_size, weights=[self.embedding_matrix]))
...
if __name__ == '__main__':
    ...
    my_model = MLP(MAX_SEQUENCE_LENGTH, max_features, embed_size, embedding_matrix)
    my_model.set_up()
